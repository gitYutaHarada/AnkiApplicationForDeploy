...
<body>
	...
	<table id="file_editer">
		...
		%>
		<th>
			<form action="/ankiApp/FileEditerJspController" method="post">
			...
			<br/>
			<form action="/ankiApp/MyPageController" method="post" onsubmit="return confirmDelete()">
	...
	<br/>
	<form action="/ankiApp/MyPageController" method="post">
